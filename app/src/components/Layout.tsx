...
const SOCIAL_LINKS = [
  { label: 'Facebook', href: 'https://www.facebook.com/TheMovementU-District/' },
  { label: 'Instagram', href: 'https://www.instagram.com/uwmovement/' },
];
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#F5F5F5' }}>
      ...
      <header className="sticky top-0 z-40" style={{ backgroundColor: UDISTRICT_COLORS.purple, borderBottom: `3px solid ${UDISTRICT_COLORS.gold}` }}>
        <div className="max-w-6xl mx-auto pl-0 pr-3 sm:pl-1 sm:pr-4 lg:pl-2 lg:pr-6 h-[68px] sm:h-16 grid grid-cols-[minmax(0,160px)_1fr_auto] sm:grid-cols-[minmax(0,220px)_1fr_auto] md:grid-cols-[minmax(0,320px)_1fr_auto] lg:grid-cols-[minmax(0,380px)_1fr_auto] xl:grid-cols-[minmax(0,440px)_1fr_auto] items-center gap-2">
          {/* Logo */}
          <NavLink to="/" className="-ml-5 sm:-ml-6 md:-ml-10 lg:-ml-12 xl:-ml-16 md:mr-3 lg:mr-4 flex items-center gap-1.5 sm:gap-2 shrink-0 min-w-0 max-w-[160px] sm:max-w-[220px] md:max-w-[320px] lg:max-w-[380px] xl:max-w-[440px] rounded-lg px-1 py-1" onClick={() => setMobileMenuOpen(false)}>
            <span
              aria-hidden="true"
            ...
            <div className="-ml-2 sm:-ml-3 min-w-0 text-left">
      ...
      <footer style={{ backgroundColor: UDISTRICT_COLORS.purple, borderTop: `3px solid ${UDISTRICT_COLORS.gold}` }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 mb-6">
            ...
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-wider mb-3" style={{ color: UDISTRICT_COLORS.gold }}>Social Media</h4>
              <div className="flex flex-col gap-2">
