...
const CATEGORY_GRADIENT: Record<string, string> = {
  food: 'from-uw-purple/90 to-uw-purple-dark/95',
  cafe: 'from-uw-gold/90 to-[#8C7A52]/95',
  services: 'from-[#5A5A5A]/90 to-[#3A3A3A]/95',
  health: 'from-emerald-600/90 to-emerald-800/95',
  retail: 'from-blue-600/90 to-blue-800/95',
};
...
export default function MerchantCarousel() {
  ...
  const gradient = CATEGORY_GRADIENT[merchant.category] || CATEGORY_GRADIENT.services;
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {merchants.map((m) => (
              <div
                key={m.id}
                className="w-full flex-shrink-0 p-6 sm:p-8 flex flex-col justify-between"
