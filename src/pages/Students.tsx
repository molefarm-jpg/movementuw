...
const BENEFITS = [
  {
    ...
    description: `The ${SITE_NAME} app is the only way to access and redeem the student discounts listed on this hub. Download to unlock every deal.`,
  },
  {
    icon: QrCode,
    title: 'Digital UofW Student ID',
    description: `Verify your student status once inside the ${SITE_NAME} app, then show your digital ID at any partner merchant to redeem instantly.`,
  },
  {
    icon: Bell,
  ...
  },
  {
    icon: Shield,
    title: 'Always Free',
    description: `The ${SITE_NAME} app is 100% free for students. No subscriptions, no fees, no catches — just verified savings on The Ave.`,
  },
];
    ...
    <div>
      ...
      <section className="pt-10 pb-6 px-4 sm:px-6 max-w-3xl mx-auto text-center">
        ...
        <h1 className="text-[32px] sm:text-[48px] font-bold text-[#1A1A1A] leading-[1.15] tracking-tight mb-4">
          ...
          {`The ${SITE_NAME} app is the only way to verify your student status and claim the merchant offers on this hub. Download the app, verify your enrollment, and start saving on The Ave today.`}
        </p>
        <a
        ...
        <div className="space-y-3">
          {[
            ...
            },
            {
              ...
              a: `Yes. All student discounts on this hub are exclusively available and redeemable through the ${SITE_NAME} app. Download is required to verify your student status and claim offers.`,
            },
            {
              q: 'Which merchants are included?',
              a: `We are continuously activating merchants on The Ave. Every offer listed on this hub requires the ${SITE_NAME} app to redeem. Check the Merchants page for the full directory.`,
            },
            {
